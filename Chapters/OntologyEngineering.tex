...
\marginpar{An example of clear conceptual modelling using roles is shown in Section \ref{Roles}.} What these different usages of the word have in common is that an ontology is a \emph{community contract}\label{CommunityContract} about the representation of a domain \cite{Hepp2007}. It also has to be maintained during its lifespan, and is created through clear conceptual modelling based on philosophical notions. 
...
\marginpar{Ontologies are particularly well-suited to domains such as biomedical research, where there is an abundance of available data with non-hierarchical relationships.}
...
\begin{figure}[bth]
	\digraph[scale=0.55]{canConnectTo}{
