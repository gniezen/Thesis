...
TODO Panos feedback pg 5
When trying to share music or photos on your mobile phone and that of a friend, making the connection between two devices is not always straightforward. You need to select the appropriate communication technology and identify the target device from a list of possible options.
