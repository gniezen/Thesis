...
\begin{figure}
\centerline{
\includegraphics[width=400px]{kdeplot}}
...
\begin{itemize}
	...
	\item Size of community: As ontologies are considered community contracts, \marginpar{For more on community contracts, see Section \ref{CommunityContract}.} an ontology targeted towards a large community should be easy to understand, well documented and of a reasonable size.
...
One developer suggested that an ontology viewer could be used to make dependencies more visible, and that Prot\'eg\'e ontology editor is too complex for most users.\marginpar{The Prot\'eg\'e ontology editor was first mentioned in Section \ref{D2Discussion}.}
