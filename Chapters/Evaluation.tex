...
\begin{itemize}
	...
	\item Large size of community: As ontologies are considered community contracts, \marginpar{For more on community contracts, see Section \ref{CommunityContract}.} an ontology targeted towards a large community should be easy to understand, well documented and of a reasonable size.
