...
\marginpar{Current remote user interfaces are device-oriented rather than task-oriented. CEA-2018, discussed in Section \ref{cea2018}, tries to solve this problem by using task model representations.}
...
\begin{figure}[bth]
        \includegraphics[width=\linewidth]{naryFunctionality}
